...
(define finalBonus2 23024719642995889770102330852603679532841155136371445865254093457902255)
...
(define finalAnswer (decode (fast-mod-exp finalBonus ME-mod ME-e)))