...
function SVGHeatmap(options) {
	...
	if(debug) console.log("Initializing a heatmap for dataset "+obj.data.id);
	...
	this.ShowData = function(r) {
		if(debug) console.log("Adding heatmap layer for dataset "+obj.data.id);
	...
	this.LoadHeatmapImage = function() {
		if(debug) console.log("Loading heatmap image to map for dataset "+obj.data.id);
